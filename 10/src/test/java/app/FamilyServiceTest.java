...
class FamilyServiceTest {
    ...
    @BeforeEach
    void createDataBeforeTest() throws ParseException {
        ...
        Woman mother1 = new Woman("Kate", "Middletone", "12/12/1954", 80, schedule1);
        Man father1 = new Man("Michael", "Kors", "24/01/1956", 60, schedule2);
        Woman mother2 = new Woman("Sara", "Cooper", "16/04/1954", 80, schedule1);
        Man father2 = new Man("Bob", "Cooper", "18/01/1956", 60, schedule2);
        Woman mother3 = new Woman("Anna", "Stone", "12/03/1954", 80, schedule1);
        Man father3 = new Man("Alex", "Stone", "16/04/1956", 60, schedule2);
        Woman child1 = new Woman("Kira", "Stone", "18/18/1990", 80);
        Man child2 = new Man("Monika", "Stone", "12/04/1987", 60);
    ...
    void createNewFamily() throws ParseException {
        ...
        Woman mother = new Woman("Kate", "Middletone", "12/12/1954", 80, schedule3);
        Man father = new Man("Michael", "Kors", "18/04/1956", 60, schedule4);
    ...
    void adoptChild() throws ParseException {
        ...
        Man child = new Man("Muhamed", "Chaker", "18/04/1985", 55);
